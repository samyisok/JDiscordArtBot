...
public class FileSendExecuterServiceTest {
    ...
    void before() {
        ...
        doReturn(fileUpload)
                .when(fileSendExecuterService)
                .getPrepFiles(fileEntity);
    ...
    void testGetPrepFiles() throws IOException {
        ...
        FileUpload fileUploadRes = fileSendExecuterService
                .getPrepFiles(fileEntity);

        assertThat(fileUploadRes).isNotNull();
        assertThat(fileUploadRes.getName()).isEqualTo("testName");
        
        assertThat(new String(fileUploadRes.getData().readAllBytes(), 
    ...
    void testIsExecuterAvailableTrue() {
        assertThat(fileSendExecuterService
